...
const EXAMPLE_QUESTIONS = [
  '诊断 S010137001002020102202026030107000021 的拆分异常原因',
  '诊断 S760237001003020200802026030100323732 的拆分异常原因',
  '查询 S760237001003020200802026030100323732 的门架交易明细',
  '查询S760237001003020200802026030100323732所有通行记录',
  '统计每个入口站的通行数量',
];
